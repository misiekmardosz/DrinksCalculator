        ...
        <>
            <section className={"container"}>
                <div className={'menu'}>
                    ...
                    <h2 className={"add--section"} onClick={addRecipeBar}>Add Recipe <FontAwesomeIcon
                        className={"chevron"} icon={faChevronDown}/></h2>
                    ...
                    <div className={"scroll-recipes"}>
                        {glasses.map((glass) => (
                            <div key={glass.id} className={"glass"}>
                                ...
                                <button onClick={(e) => handleGlassDelete(e, glass.id)}><FontAwesomeIcon
                                    icon={faTrash}/></button>
                ...
                >
                    <RecipeDetails recipe={openedRecipe} glasses={glasses} open={recipeModalIsOpen} close={closeModal}
                                   deleteRecipe={deleteRecipe} cancel={cancelButton}/>
                </Modal>
                <Modal
                    s
